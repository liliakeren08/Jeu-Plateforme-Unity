...
public class FireballWeapon : Weapons
{
    ...
    [SerializeField] private float _speed = 15f; // Vitesse augmentée (quasi instantanée)
    ...
    {
        // On attend juste 1 image (très rapide) pour que l'animation commence
        yield return null;
    ...
    private void ApplyLevelBonus(int level)
    {
        switch (level)
        {
            ...
            case 6: _sizeMultiplier += 0.5f; break;
            case 7:
